...
\begin{frame}[fragile]
  ...
  \warnblock{The use of \kw{friend}s can undermine encapsulation, after all you're giving away access to parts of your class that were designed to be kept internal.
  \newline\pause
...
\begin{frame}
  ...
  \begin{itemize}
  	\item<2->{Friendship isn't reciprocated: Just because a friend can access my \kw{private}s doesn't mean I can access theirs.  They have to explicitly mark me as a \kw{friend}.}
    \item<3->{Friendship isn't transitive: Friends of my friends can't access my \kw{private}s.}
    \item<4->{Friendship isn't inherited:  My friends can't access my children's privates \kw{private}s.}
    \item<5->{Friendship isn't automatic: I can't access my children's \kw{private}s.}
  \end{itemize}
